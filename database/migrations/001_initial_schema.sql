-- Kursy App Modern – schemat początkowy (tabele, enumy, indeksy, triggery, RLS)
-- Uruchom w Supabase SQL Editor jako pierwszy.
...
-- Courses visible to all, admins can modify
